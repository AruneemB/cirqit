...
export const ExecutionStatus: React.FC = () => {
  ...
  return (
    <div className="absolute bottom-4 left-4 bg-panel/80 backdrop-blur-sm border border-violet-soft/20 px-4 py-2 rounded-full text-xs text-text-secondary flex items-center gap-2 z-50">
